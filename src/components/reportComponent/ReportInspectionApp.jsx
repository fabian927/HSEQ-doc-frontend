...
import { useGetDocuments } from './GetDocReport'; 
import { generarPDF } from './pdfComponent/InspHerrManualesPdf';


const ReportInspectionApp = () => {
    ...
    const { getDocumentsReports } = useGetDocuments();
    ...
    const columnas = [
     ...
     useEffect(() => {
        ...
        getDocumentsReports(userId, (response) => {
          setTimeout(() => {
            if (response.status) {
...
export default ReportInspectionApp
